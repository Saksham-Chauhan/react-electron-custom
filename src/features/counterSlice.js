...
export const fetchSafeModeDelayState = (state) => state[STATE_KEY].safeModedelay
...
export const fetchUserLoggedInState = (state) => state[STATE_KEY].isUserLoggedIn
...
export const fetchNftWalletListState = (state) => state[STATE_KEY].nftWalletList
